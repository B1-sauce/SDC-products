...
CREATE TABLE products(
  product_id INT SERIAL NOT NULL PRIMARY KEY,
  name VARCHAR(40),
  slogan VARCHAR(40),
...
CREATE TABLE features(
  feature_id INT SERIAL NOT NULL PRIMARY KEY,
  feature VARCHAR(40),
  value VARCHAR(40),
  product_id INT NOT NULL ,
  FOREIGN KEY (product_id) REFERENCES products(product_id)
...
CREATE TABLE styles(
  style_id INT SERIAL NOT NULL PRIMARY KEY,
  name VARCHAR(40),
...
CREATE TABLE photos(
  photo_id INT SERIAL NOT NULL PRIMARY KEY,
...
CREATE TABLE skus(
  skus_id INT SERIAL NOT NULL PRIMARY KEY,
  quantity INT,
